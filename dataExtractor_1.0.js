...
var { excelSaveResume, excelSaveCmeGroup } = require('./drivers.js');
...
function getCmeGroup(date, globalConfig) {
    ...
    try {
        ...
        excelSaveCmeGroup (settlementData, __dirname + "\\data\\", globalConfig);
        excelSaveResume (settlementResume, __dirname + "\\data\\", globalConfig);
        return result;
    } catch (error) {
